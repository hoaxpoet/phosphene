...
`CouplingReportTests.swift` + `MultiPassRenderHarness.swift` (producer + shared render), `MultiPassFlashHarnessTests.swift` (the flash gate that shares the harness), `docs/diagnostics/QG1_REPLAY_AUDIT.md`, `docs/ENGINE/SESSION_REPLAY.md` (SR.1 uncalibrated-proxy doctrine), [D-185] (metric), [D-186] (measurement substrate + calibration), [D-180] (route-coverage + the CPU-computed StemFeatures fixture boundary), FA #27, FA #66 (drive the live path, never reimplement).
