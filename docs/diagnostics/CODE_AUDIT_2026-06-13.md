...
| CLEAN.6.2 | BUG-042 re-express structural stream at ~2 Hz section scale; recalibrate vs real session streams; re-express BUG-035/040 tests | **⏳ fix + recalibration landed 2026-06-19** — 2 Hz time-bucketed decimation + BUG-035/040/AABA tests re-expressed (DSP 23/23 green); `minNoveltyFloor` **recalibrated 0.02→0.01** (live SLTS diagnosis via raw_tap sweep — 9 sections @ conf 0.64); Matt's live re-test pending (§KNOWN_ISSUES BUG-042) |
