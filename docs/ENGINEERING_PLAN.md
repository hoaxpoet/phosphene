...
**Status.** AV.1 ✅ (2026-05-18). AV.2 ✅ (2026-05-18). AV.2.1 ❌ (2026-05-18, misdiagnosed motion-smear hotfix; superseded). AV.2.2 ✅ (2026-05-18, mv_warp dropped after empirical multi-frame diagnostic). AV.2.2a ✅ (2026-05-18, drawDirect slot-6 binding hotfix — necessary but not sufficient). AV.2.2b ✅ (2026-05-18, moved Aurora Veil state allocation out of `case .mvWarp:` so it fires for `passes: []`). AV.2.3 ⏳ (re-introduce drift mechanisms grounded in dossier + applyPreset integration test that catches the AV.2.2b class of regression). AV.3 ⏳. **Schedule:** AV.2.3 after Matt's live re-verification of AV.2.2 + AV.2.2a + AV.2.2b; AV.3 after AV.2.3 + an empirical-grounding research pass for sub-second flicker + 2–20 s pulsation.
