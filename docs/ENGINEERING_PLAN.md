...
### Phase SECDET — Section-detection rebuild: port McFee/Ellis spectral clustering to Swift/Accelerate ⏳ (2026-06-23; **offline port COMPLETE — SECDET.1–.4 done**, F@3 reproduces the lab on real tracks (≈0.41/0.61); the **live gate — Matt confirming transitions land on the audible section breaks — is the only thing left**; kickoff `~/phosphene_section_lab/PORT_KICKOFF.md`, D-170)
