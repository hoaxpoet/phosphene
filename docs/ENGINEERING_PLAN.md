...
### Phase SECDET — Section-detection rebuild: port McFee/Ellis spectral clustering to Swift/Accelerate ⏳ (2026-06-23, staged; kickoff `~/phosphene_section_lab/PORT_KICKOFF.md`, D-170)
...
- **SECDET.4 — Offline F-score acceptance (pending).** Run the Swift path over Nirvana + a Beatles subset; confirm F@3 reproduces the lab (Beatles ≈ 0.41, Nirvana ≈ 0.61). This is the acceptance gate.
