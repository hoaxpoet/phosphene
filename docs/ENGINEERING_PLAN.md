...
### Increment NACRE.1 + .2a + .2b + .3 + .4 — Nacre: faithful port + audio coupling, CERTIFIED ✅ (2026-06-26, D-171; **certified — connection lands via the downbeat camera push; flash-safe + rubric-passed**)
