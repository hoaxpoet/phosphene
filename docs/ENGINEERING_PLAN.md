...
**Status.** AV.1 ✅ (2026-05-18). AV.2 ✅ (2026-05-18). AV.2.1 ❌ (2026-05-18, misdiagnosed motion-smear hotfix; superseded). AV.2.2 ✅ (2026-05-18, mv_warp dropped after empirical multi-frame diagnostic). AV.2.2a ✅ (2026-05-18, drawDirect slot-6 binding hotfix). AV.2.2b ✅ (2026-05-18, moved Aurora Veil state allocation out of `case .mvWarp:`). AV.2.2c ✅ (2026-05-19, calmer-tuning amplitude pass after first successful live session). AV.2.3 ⏳ (dossier-grounded redesign + integration test). AV.3 ⏳. **Schedule:** AV.2.3 after Matt's live re-verification of AV.2.2c.
