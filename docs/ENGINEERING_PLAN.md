...
## Phase MOOD-FLUX — MoodClassifier offline flux-feature repair (BUG-066) 🔨 (2026-07-08; surfaced by CENSUS.3)
...
### Ricercar — FANTASIA REBUILD (RICERCAR-FL, branch `claude/ricercar-rework`) ★ supersedes R.4–R.8 and the marks paradigm
...
- **FL.4 ⏳** audio wiring (family → which colours bloom/which ribbons brighten; zero-lag `*_dev` → flow vigour + ribbon undulation + splat force; beats → splat impulses). Gated on Matt's live look review.
