...
### Increment GLAZE.7 — Glaze uplift C (reconceived): a discrete downbeat camera push (the connection "snap") ⏳ code-complete, pending live M7 (2026-06-28)
...
### Increment GLAZE.6 — Glaze uplift B: HDR glossy bloom (display-only, wash- + flash-safe) ⏳ code-complete, pending live M7 (2026-06-27)
...
### Increment GLAZE.5 — Glaze uplift A: per-stem instrument routing (drums punch + vocals glow) ⏳ code-complete, pending live M7 (2026-06-27)
...
### Increment GLAZE.4 — Glaze: fix the wash-out (comp brightness floor + self-limiting seed) ⏳ code-complete, pending live M7 (2026-06-27)
