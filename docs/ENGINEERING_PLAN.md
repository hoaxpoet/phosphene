...
PLL/Kalman phase-period controller (replay-first), drums-stem onset evidence upgrade, BUG-065 closure. 3–4 sessions, independent of DBN. spec: BEAT_SYNC_PROGRAM_PLAN.md §4. **Phase status: STALLED pending Matt's decision — both levers measured, neither closes BUG-065.**
