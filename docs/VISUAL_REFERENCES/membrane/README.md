# Visual References — Membrane

**Family:** fluid
**Render pipeline:** feedback
...
- [ ] **Hero noise function(s):** `<e.g. fbm8 + curl_noise>` (from `Shaders/Utilities/Noise/`)
- [ ] **Material count and recipes:** `<e.g. mat_ocean + mat_frosted_glass + mat_ink>` (from `Shaders/Utilities/Materials/` V.3)
- [ ] **Audio reactivity:** deviation primitives this preset must use (e.g. `f.bass_dev`, `f.treb_att_rel` per D-026)
