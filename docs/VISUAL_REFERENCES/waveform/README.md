# Visual References — Waveform

**Family:** waveform
**Render pipeline:** direct
**Rubric:** lightweight — stylized 2D waveform / spectrum (exempt from full detail-cascade + material-count requirements)
...
- [ ] **Audio coverage:** <which audio signals must be visually represented at all times>
