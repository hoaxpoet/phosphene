...
Captured 2026-05-10 (LM.3.2 calibration round 8 — beat envelope removed) via `RENDER_VISUAL=1 swift test --package-path UzumeEngine --filter "PresetVisualReviewTests/renderPresetVisualReview"`.
