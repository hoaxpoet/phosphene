...
Captured 2026-05-10 (LM.3.2 calibration round 4 — HSV palette) via `RENDER_VISUAL=1 swift test --package-path PhospheneEngine --filter "PresetVisualReviewTests/renderPresetVisualReview"`.
