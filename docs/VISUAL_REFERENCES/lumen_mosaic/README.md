...
6. **`CheckVisualReferences --strict` must pass.** Run `swift run --package-path UzumeTools CheckVisualReferences --strict` after any change to this folder. The 5 lint rules per D-064 are non-negotiable.
