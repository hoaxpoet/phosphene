...
**Status:** Scoped + feasibility-spiked 2026-06-29 (D-177). **Deferred to a fresh session, pending Matt's comparison with a competing musicality idea.** Not yet committed to the roadmap. This doc is self-contained — a fresh session should be able to execute from it, and it is written to be compared, plan-to-plan, on cost / benefit / risk.
