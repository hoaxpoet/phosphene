...
**Date:** 2026-09-03 · **Increment:** DS.6 · **Status:** Accepted (Matt decided the inactivity
question in his own words, relayed through the DS.6 prompt's §DECISION-NEEDED 2 the same day; the
other two are the prompt's defaults; M7 pending — the verdict is recorded in
`docs/ENGINEERING_PLAN.md` §DS.6)
