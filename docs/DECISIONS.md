...
macOS sees. Internal module, target, scheme, package and directory names stay `Phosphene*`;
that is RN.2.
...
| Built product | `PhospheneApp.app` | `Uzume.app` |
| Swift module | `PhospheneApp` | `PhospheneApp` (pinned — RN.2) |
| URL scheme | `phosphene://` | `uzume://` |
...
| Application Support | `Phosphene/` | `Uzume/` |
| Repo | `hoaxpoet/phosphene` | `hoaxpoet/uzume` |
