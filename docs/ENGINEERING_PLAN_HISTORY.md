...
| 2 | Delete `Scripts/convert_beatnet_weights.py` | ✅ | Deleted 2026-06-14 (D-163 follow-up). This catalog originally marked it ⊘ (already-removed), but it sat on disk until now; the converter — the last BeatNet-derived artifact — is finally removed and the `CREDITS.md` BeatNet section historicized. |
...
- #2 `Scripts/convert_beatnet_weights.py` — deleted 2026-06-14 (D-163 follow-up). Originally mis-recorded here as already-removed; it was on disk until the D-163 cleanup actually removed it (last BeatNet-derived artifact; `CREDITS.md` historicized).
...
## DOC.6 closed-phase rotation batch (2026-06-12, same convention)
