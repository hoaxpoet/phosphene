...
| **`transitionPolicy: any TransitionDeciding`** | **`production-orphan`** | Declared `:176` + initialized `:188-191`; **never invoked anywhere in `LiveAdapter*.swift`** | See production-orphan finding above; `CA.4-FU-1` |
