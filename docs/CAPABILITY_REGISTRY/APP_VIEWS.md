...
|---|---|---|---|---|
| **CA.6-FU-1** | ✅ **Closed 2026-05-21.** Rewrote `DashboardOverlayView.swift:10` file-header docstring "0.55α" → "0.96α" + reworded the rationale ("near-opaque to guarantee WCAG AA contrast … remaining 4 % translucency is decorative") to match the existing line-50-56 block lower in the file. Code at line 57 unchanged. | Closed. | <1 | ✅ Resolved 2026-05-21 |
