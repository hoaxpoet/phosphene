...
**Status: fixed 2026-08-27 — Matt chose (a), the lay-order tie-break — and PENDING HIS M7.**
...
- [ ] **Matt's M7: the overlaps stop flickering AND the colour that wins is the right one.** The real verification.
