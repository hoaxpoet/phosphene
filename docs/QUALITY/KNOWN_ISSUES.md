...
**P1 · preset.fidelity / sdf-geometry / render-state · FIXES LANDED (direction, zoom target, anti-aliasing, jitter accumulation, steering rebuild), live re-test pending.**
