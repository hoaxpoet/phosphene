...
- [ ] **The hoist implemented**, with the same harness showing the `breakCount` dependence gone and the 16-breakpoint case back near the 1-breakpoint floor.
