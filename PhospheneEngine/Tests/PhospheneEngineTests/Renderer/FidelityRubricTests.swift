...
private let expectedAutomatedGate: [String: Bool] = [
    ...
    "Fractal Fly-By":      false,   // FD.1 maquette is deliberately audio-inert (the task-3
                                     // perf gate measures geometry alone); no routes yet
...
struct FidelityRubricGateTests {
    ...
    private static let certifiedPresets: Set<String> = ["Lumen Mosaic", "Ferrofluid Ocean", "Dragon Bloom", "Fata Morgana", "Murmuration", "Nimbus", "Skein", "Nacre", "Floret", "Glaze", "Filigree", "Mitosis", "Cytokinesis", "Aurora Veil", "Cymatic Resonance", "Volumetric Lithograph"]
