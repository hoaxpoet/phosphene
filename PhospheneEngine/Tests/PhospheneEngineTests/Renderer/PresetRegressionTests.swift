...
private let goldenPresetHashes: [String: PresetHashes] = [
    ...
    // PG.4.1 (D-189): Truchet Loom golden. The regression harness binds a zeroed
    ...
    // PG.4.2 (D-190): per-path HUE TEAMS colour the ribbons (spectral_centroid = 0
    ...
    // PG.4.3 (D-191): regenerated — the hue-team block edges are now domain-warped
