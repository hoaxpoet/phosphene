...
1. **Increment 6.1 — Progressive Session Readiness.** Gates the "Start now" CTA in `PreparationProgressView` (dormant in U.4 via `FeatureFlags.progressiveReadiness = false`). See `docs/ENGINEERING_PLAN.md §Phase 6`.
